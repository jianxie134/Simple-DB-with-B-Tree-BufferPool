...
namespace db {
    class BufferPool {
        ...
        int numPages;
        PagesMap pages; // The PagesMap is used to maintain a mapping between PageId's and their corresponding Pages.
//        std::list<PageId> lruList; // A list to track the least recently used pages for eviction purposes.
    ...
    public:
        ...
        /**
         * Flush all dirty pages to disk. Should call flushPage method on all pages in the BufferPool.
         */
        void flushAllPages();
